          ...
          <CardContent>
            <div className="space-y-3 max-h-80 overflow-y-auto">
              {[
                ...
                <div
                  key={index}
                  className="text-xs border-l-2 border-emerald-600 pl-3 hover:bg-neutral-800 p-2 rounded transition-colors"
                >
                  <div className="text-neutral-500 font-mono">{log.time}</div>
                  <div className="text-white">
                    Agent <span className="text-emerald-600 font-mono">{log.agent}</span> {log.action}{" "}
                    <span className="text-white font-mono">{log.location}</span>
                    {log.target && (
                      <span>
                        {" "}
                        with agent <span className="text-emerald-600 font-mono">{log.target}</span>
                      </span>
                    )}
                  </div>
                </div>
        ...
        <Card className="lg:col-span-4 bg-neutral-900 border-neutral-700">
          ...
          <CardContent className="flex flex-col items-center">
            ...
            <div className="text-xs text-neutral-500 space-y-1 w-full font-mono">
              ...
              <div className="text-emerald-600">{"> CH#2 | 1231.9082464.500...xR3"}</div>
