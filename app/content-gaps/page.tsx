  ...
  return (
    <div className="p-6 space-y-6 min-h-screen bg-gradient-to-br from-black via-neutral-900 to-emerald-900/20">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white tracking-wider">CONTENT GAPS</h1>
          <p className="text-sm text-neutral-400">Identify and fill content distribution gaps</p>
        </div>
        <div className="flex gap-2">
          <Button className="bg-emerald-600 hover:bg-emerald-700 text-white">Auto-Fill Gaps</Button>
          <Button className="bg-emerald-600 hover:bg-emerald-700 text-white">Content Planner</Button>
        </div>
      </div>
            ...
            <CardHeader className="pb-3">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-xs text-neutral-400 font-mono">{gap.id}</p>
                </div>
          ...
          <Card className="bg-neutral-900 border-neutral-700 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <p className="text-sm text-neutral-400 font-mono">{selectedGap.id}</p>
              </div>
              <Button
                variant="ghost"
