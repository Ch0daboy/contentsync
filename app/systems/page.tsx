    ...
    <div className="p-6 space-y-6 min-h-screen bg-gradient-to-br from-black via-neutral-900 to-emerald-900/20">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-2">
          <Button className="bg-emerald-600 hover:bg-emerald-700 text-white">System Scan</Button>
          <Button className="bg-emerald-600 hover:bg-emerald-700 text-white">Maintenance Mode</Button>
        </div>
      </div>
          ...
          <Card className="bg-neutral-900 border-neutral-700 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex gap-2 pt-4 border-t border-neutral-700">
                <Button className="bg-emerald-600 hover:bg-emerald-700 text-white">Restart System</Button>
                <Button
                  variant="outline"
