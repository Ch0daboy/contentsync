    ...
    <div className="p-6 space-y-6 min-h-screen bg-gradient-to-br from-black via-neutral-900 to-emerald-900/20">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-2">
          <Button className="bg-emerald-600 hover:bg-emerald-700 text-white">Deploy Agent</Button>
              ...
              <tbody>
                {filteredAgents.map((agent, index) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4">
                      <Button variant="ghost" size="icon" className="text-neutral-400 hover:text-emerald-600">
          ...
          <Card className="bg-neutral-900 border-neutral-700 w-full max-w-2xl">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2 pt-4">
                <Button className="bg-emerald-600 hover:bg-emerald-700 text-white">Assign Mission</Button>
                <Button
                  variant="outline"
